...
bool compare_p_test(element_t elem1, element_t elem2){
    if (elem1.p == elem2.p) return true;
    return false;
}

bool compare_s_test(element_t elem1, element_t elem2){
...
void test_list_get(){
    ...
    unsigned short placement2 = list_expand(list, elem1, compare_p_test);
    unsigned short placement3 = list_expand(list, elem2, compare_s_test);
    printf("pl1: %hu pl2: %hu pl3: %hu", placement1, placement2, placement3);
