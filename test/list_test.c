...
bool compare_test(element_t elem1, element_t elem2){
    if (elem1.p == elem2.p) return true;
    if (elem1.s == elem2.s) return true;
    return false;
}
...
void test_list_expand(){
    ...
    element_t elem2 = {.s = 1};
    unsigned short placement1 = list_expand(list, elem1, compare_test);
    unsigned short placement2 = list_expand(list, elem1, compare_test);
    unsigned short placement3 = list_expand(list, elem2, compare_test);
