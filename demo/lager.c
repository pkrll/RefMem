...
//TODO skriv destruktorfunktionen, vad är det för destructorfunktion?
//Byt alla malloc mot det som finns i våran, är det allocate?
//För varje alloc ska vi kanske enropa retain? men vi måste också om vi pekar om måste vi releasa gemla objektet och retaina det nya
//alla free ska anropa deallocate
