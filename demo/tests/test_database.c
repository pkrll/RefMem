...
void test_database_iterator_has_next() {
  
}

void test_database_iterator_next() {
}

void test_database_iterator_get() {
}

void test_database_iterator_size() {
}

void test_database_iterator_delete() {
}
...
int main(int argc, char *argv[]) {
  ...
  CU_add_test(database, "Delete", test_database_delete);
  CU_add_test(database, "Apply", test_database_apply);
  CU_add_test(database, "Is sorted", test_database_is_sorted);
  CU_add_test(database, "Sort", test_database_sort);


  CU_pSuite iterator = CU_add_suite("Test database iterator", NULL, NULL);
  CU_add_test(database, "New iterator", test_database_iterator);
  CU_add_test(database, "Iterator has next", test_database_iterator_has_next);
  CU_add_test(database, "Iterator next", test_database_iterator_next);
  CU_add_test(database, "Iterator get", test_database_iterator_get);
  CU_add_test(database, "Iterator size", test_database_iterator_size);
